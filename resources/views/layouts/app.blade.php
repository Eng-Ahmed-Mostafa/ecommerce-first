                        ...
                        <div class="main-categori-wrap d-none d-lg-block">
                            ...
                            <div class="categori-dropdown-wrap categori-dropdown-active-large">
                                <ul>
                                    ...
                                    <li><a href="{{ route('home.index') }}"><i class="surfsidemedia-font-home"></i>Home & Garden</a></li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="#">My Account<i class="fi-rs-angle-down"></i></a>
                                        <ul class="sub-menu">
                                            ...
                                            @else
                                                <li><a href="{{ Auth::user()->utype === 'ADM' ? route('admin.index') : route('user.index') }}">Dashboard</a></li>
                                            @endguest
