        ...
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                ...
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <i class="{{ route('admin.products') }}"></i>
                    </li>
                    <li>
            ...
            <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data"
                ...
                <div class="wg-box">
                    <fieldset class="name">
                        ...
                        <input class="mb-10" type="text" placeholder="Enter product name" name="name" id="name"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="mb-10" type="text" placeholder="Enter product slug" name="slug" id="slug"
                ...
                <div class="wg-box">
                    <fieldset>
                        ...
                        <div class="upload-image flex-grow">
                            <div class="item" id="imgpreview" style="display:none">
                                <img id="previewImg" src="../../../localhost_8000/images/upload/upload-1.png"
                                    class="effect8" alt="">
                            </div>
                    ...
                    <fieldset>
                        ...
                        <div class="upload-image mb-16">
                            ...
                            <div class="gimgpreview row justify-content-center align-items-center g-2" style="display: none;"></div>

                            <!-- Upload Button -->
                            <div id="galUpload" class="item up-load text-center">
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            $("#gFile").on("change", function(event) {
                let files = event.target.files;
                let previewContainer = $(".gimgpreview");

                previewContainer.empty().show(); // Clear previous images and show preview container
