        ...
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{ route('admin.category.update') }}" method="POST"
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Category name" id="name" name="name"
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Category Slug" id="slug" name="slug"
                ...
                <fieldset>
                    ...
                    <div class="upload-image flex-grow">
                        ...
                        <div class="item text-center position-relative" id="imgpreview">
                            <img src="{{ Storage::url($category->image) }}" id="previewImg" class="effect8 img-fluid rounded shadow" alt="Preview Image">
                        </div>
